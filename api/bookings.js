...
<body>
  ...
  try {
    ...
    let dataQuery = `
      SELECT booking_number, COALESCE(order_number, '') as order_number, book_date, tour_date, customer_name, sku, program, op, ri, customer, hotel, adult, child, infant, phone_number, rate, addons, updated_fields
      FROM bookings
      ${whereClause}
